...
const AnalyticChildFamily = () => {
  ...
  const series = ecosystemChildFamilyResult &&
    ecosystemChildFamilyResult && [
      {
        name: 'Active',
        data: ecosystemChildFamilyResult.actives.map((c) => c.family.activeUsers),
      },
      {
        name: 'Not Active',
        data: ecosystemChildFamilyResult.actives.map(
          (c) => c.family.familyCount - c.family.activeUsers,
        ),
      },
    ];
  ...
  return (
    <DashboardCard
      title="Children Family Activity - Overall"
...
export default AnalyticChildFamily;
