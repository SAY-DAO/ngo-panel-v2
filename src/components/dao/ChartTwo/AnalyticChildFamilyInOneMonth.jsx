...
const AnalyticChildFamilyInOneMonth = () => {
  ...
  const series = ecosystemChildFamilyResult &&
    ecosystemChildFamilyResult && [
      {
        name: 'Active',
        data: ecosystemChildFamilyResult.actives.map((c) => c.family.activeUsersInOneMonths),
      },
    ];

  return (
    <DashboardCard
      title="Children Family Activity - one Month"
...
export default AnalyticChildFamilyInOneMonth;
