...
export const MIGRATE_CHILDREN_REQUEST = 'MIGRATE_CHILDREN_REQUEST';
export const MIGRATE_CHILDREN_SUCCESS = 'MIGRATE_CHILDREN_SUCCESS';
export const MIGRATE_CHILDREN_FAIL = 'MIGRATE_CHILDREN_FAIL';
export const MIGRATE_CHILDREN_RESET = 'MIGRATE_CHILDREN_RESET';
