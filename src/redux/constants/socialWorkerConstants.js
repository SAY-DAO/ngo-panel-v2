export const SW_PROFILE_REQUEST = 'SW_PROFILE_REQUEST';
export const SW_PROFILE_SUCCESS = 'SW_PROFILE_SUCCESS';
export const SW_PROFILE_FAIL = 'SW_PROFILE_FAIL';
export const SW_PROFILE_RESET = 'SW_PROFILE_RESET';
