const contents = {
  ...
  minLengthPassword: 'error.minLengthPassword',
  specialCharPassword: 'error.specialCharPassword',
  numberPassword: 'error.numberPassword',
  capitalPassword: 'error.capitalPassword',
  lowercasePassword: 'error.lowercasePassword',
  wrongCurrentPassword: 'error.wrongCurrentPassword',
